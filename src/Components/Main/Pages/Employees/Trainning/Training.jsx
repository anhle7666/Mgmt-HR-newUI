...
const Training = () => {
    ...
    const handleSumbitForm = async (e) => {
        ...
        const res = await EmployeeServices.addTrainingEmloyee(selected._id, json);
        console.log(res);
    };
    return (
        <>
            ...
            <div className="bg-base-300">
                <table className="table table-compact w-full ">
                    ...
                    <tbody>
                        {selected.training.map((course, i) => (
                            <tr key={course.IDCourse + i}>
                                <td>{course.IDCourse}</td>
                                <td>{course.nameCourse}</td>
                                <td>{course.startCourse}</td>
                                <td>{course.durationCourse}</td>
                                <td>{course.trainingContent}</td>
                            </tr>
                        ))}
                    </tbody>
                </table>
